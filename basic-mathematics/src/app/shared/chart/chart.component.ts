...
export class ChartComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.treeLayout.size([height, width]);
    ...
    this.root = d3.hierarchy(data, function(d: any) { return d.children});
    this.root.x0 = 450;
    this.root.y0 = 0;
 ...
 private update(source) {
    ...
    nodeEnter.append("circle")
      .attr("r", 0)
      .style("fill", d => {
        return d._children ? "lightsteelblue" : "#111";
      });
